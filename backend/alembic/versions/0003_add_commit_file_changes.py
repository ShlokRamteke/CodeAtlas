...
def upgrade() -> None:
    ...
    op.add_column('commits', sa.Column('files_changed_count', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('commits', sa.Column('insertions', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('commits', sa.Column('deletions', sa.Integer(), nullable=False, server_default='0'))

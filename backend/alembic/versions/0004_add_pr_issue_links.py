...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("commit_id", sa.Uuid(as_uuid=True), sa.ForeignKey("commits.id", ondelete="CASCADE"), nullable=False),
        sa.Column("pull_request_id", sa.Uuid(as_uuid=True), sa.ForeignKey("pull_requests.id", ondelete="CASCADE"), nullable=True),
    ...
    op.create_index("ix_commit_pull_request_links_commit_id", "commit_pull_request_links", ["commit_id"])
    op.create_index("ix_commit_pull_request_links_pull_request_id", "commit_pull_request_links", ["pull_request_id"])
    op.create_index("ix_commit_pull_request_links_pr_number", "commit_pull_request_links", ["pr_number"])
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(as_uuid=True), primary_key=True, nullable=False),
        sa.Column("commit_id", sa.Uuid(as_uuid=True), sa.ForeignKey("commits.id", ondelete="CASCADE"), nullable=False),
        sa.Column("issue_id", sa.Uuid(as_uuid=True), sa.ForeignKey("issues.id", ondelete="CASCADE"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(as_uuid=True), primary_key=True, nullable=False),
        sa.Column("pull_request_id", sa.Uuid(as_uuid=True), sa.ForeignKey("pull_requests.id", ondelete="CASCADE"), nullable=False),
        sa.Column("issue_id", sa.Uuid(as_uuid=True), sa.ForeignKey("issues.id", ondelete="CASCADE"), nullable=True),
        sa.Column("issue_number", sa.Integer(), nullable=False),
        sa.Column("link_type", sa.String(50), nullable=False, server_default="references"),
        sa.Column("raw_reference", sa.String(255), nullable=True),
    ...
    op.create_index("ix_pull_request_issue_links_pull_request_id", "pull_request_issue_links", ["pull_request_id"])
    op.create_index("ix_pull_request_issue_links_issue_id", "pull_request_issue_links", ["issue_id"])
    op.create_index("ix_pull_request_issue_links_issue_number", "pull_request_issue_links", ["issue_number"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_pull_request_issue_links_pull_request_id", table_name="pull_request_issue_links")
    ...
    op.drop_index("ix_commit_pull_request_links_pull_request_id", table_name="commit_pull_request_links")

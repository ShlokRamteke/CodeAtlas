...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_source_files_repository_id"), "source_files", ["repository_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "claims", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default="[]"
        ),
    ...
    op.create_index(
        op.f("ix_investigations_repository_id"), "investigations", ["repository_id"], unique=False
    )
